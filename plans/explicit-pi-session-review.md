...
This task must deepen those seams without widening `evidence.Bundle`, evaluator schemas, prompts, RPC, or the generic learning-history interface. ADR-0006 is proposed with this plan. Neither document authorizes implementation.
...
- `TODO / Need Confirmation` — ADR-0006 is proposed, not accepted. Phase 1 needs explicit user authorization after ADR acceptance.
